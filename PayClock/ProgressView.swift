...
class ProgressView: UIView {
  ...
  /*  //func createLabel() {
    ...
    private func createProgressLayer() {
        ...
        progressLayer.path = UIBezierPath(arcCenter:centerPoint, radius: CGRectGetWidth(frame)/2 - 84.0, startAngle:startAngle, endAngle:endAngle, clockwise: true).CGPath
    ...
    private func gradientMask() -> CAGradientLayer {
        ...
        let colorTop: AnyObject = UIColor(red: 249.0/255.0, green: 118.0/255.0, blue: 103.0/255.0, alpha: 1.0).CGColor
        let colorBottom: AnyObject = UIColor(red: 249.0/255.0, green: 118.0/255.0, blue: 103.0/255.0, alpha: 1.0).CGColor
    ...
    func animateProgressView() {
      //  progressLabel.text = "Loading..."
        ...
        animation.duration = settingsDict["LittleCircle"]! / secondRate
